...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems(new String("${page.result}"));
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t<tr>\r\n");
          out.write("\t\t<td>");
          out.write("${m.customerId}");
          out.write("</td>\r\n");
          out.write("\t\t<td>");
          out.write("${m.showName}");
          out.write("</td>\r\n");
          out.write("\t\t<td>");
          out.write("${m.trueName}");
          out.write("</td>\r\n");
          out.write("\t\t<td>");
          out.write("${m.pwd}");
          out.write("</td>\r\n");
          out.write("\t\t<td>");
          out.write("${m.registerTime}");
          out.write("</td>\r\n");
          out.write("\t\t<td>\r\n");
          out.write("\t\t\t<a href=\"");
          out.write("${pageContext.request.contextPath}");
  ...
  private boolean _jspx_meth_myTag_page_0(PageContext _jspx_page_context)
    ...
    _jspx_th_myTag_page_0.setPage((com.wwn.customer.pageutil.Page)org.apache.jasper.runtime.JspRuntimeLibrary.getValueFromPropertyEditorManager(com.wwn.customer.pageutil.Page.class, "page", "${page}"));
